 ...
 */
public class bodsee8 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bodsee8);
        init();
        button();
        checkans();
    }
    ...
    private void checkans(){
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(bodsee8.this);
                builder.setTitle("ตรวจสอบ");
                if(test.getText().toString().equals("15"))
                    answer = "Yes";
                else
                    answer = "No";
