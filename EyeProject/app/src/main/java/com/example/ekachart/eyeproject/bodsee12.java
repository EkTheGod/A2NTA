 ...
 */
public class bodsee12 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bodsee12);
        init();
        button();
        checkans();
    }
    ...
    private void checkans(){
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(bodsee12.this);
                builder.setTitle("ตรวจสอบ");
                if(test.getText().toString().equals("3"))
                    answer = "Yes";
                else
                    answer = "No";
