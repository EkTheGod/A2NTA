 ...
 */
public class bodsee4 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bodsee4);
        init();
        button();
        checkans();
    }
    ...
    private void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),bodsee3.class);
                startActivity(i);
            }
        });
    ...
    private void checkans(){
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(bodsee4.this);
                builder.setTitle("ตรวจสอบ");
                if(test.getText().toString().equals("16"))
                    answer = "Yes";
                else
                    answer = "No";
