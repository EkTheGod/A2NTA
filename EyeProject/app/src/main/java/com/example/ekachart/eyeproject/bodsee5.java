 ...
 */
public class bodsee5 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bodsee5);
        init();
        button();
        checkans();
    }
    ...
    private void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),bodsee4.class);
                startActivity(i);
            }
        });
    ...
    private void checkans(){
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(bodsee5.this);
                builder.setTitle("ตรวจสอบ");
                if(test.getText().toString().equals("7"))
                    answer = "Yes";
                else
                    answer = "No";
