 ...
 */
public class bodsee10 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bodsee10);
        init();
        button();
        checkans();
    }
    ...
    private void button(){
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),bodsee9.class);
                startActivity(i);
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),bodsee11.class);
                startActivity(i);
            }
        });
    ...
    private void checkans(){
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(bodsee10.this);
                builder.setTitle("ตรวจสอบ");
                if(test.getText().toString().equals("97"))
                    answer = "Yes";
                else
                    answer = "No";
