 ...
 */
public class bodsee13 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bodsee13);
        init();
        button();
        checkans();
    }
    ...
    private void checkans(){
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(bodsee13.this);
                builder.setTitle("ตรวจสอบ");
                if(test.getText().toString().equals("73"))
                    answer = "Yes";
                else
                    answer = "No";
