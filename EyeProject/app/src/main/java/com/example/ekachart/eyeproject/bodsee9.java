 ...
 */
public class bodsee9 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bodsee9);
        init();
        button();
        checkans();
    }
    ...
    private void checkans(){
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(bodsee9.this);
                builder.setTitle("ตรวจสอบ");
                if(test.getText().toString().equals("9"))
                    answer = "Yes";
                else
                    answer = "No";
